...
def read_dataset(path):
    data_list = []
    label_list = []
    my_list = os.listdir(r'D:\dataset\newdataset\archive\Datasets')
    i=-1
    for pa in my_list:
        i=i+1
        print(pa,"==================",i)
        for root, dirs, files in os.walk(r'D:\dataset\newdataset\archive\Datasets\\' + pa):

         for f in files:
            file_path = os.path.join(r'D:\dataset\newdataset\archive\Datasets\\'+pa, f)
...
# load dataset
x_dataset, y_dataset = read_dataset(r"D:\dataset\newdataset\archive\Datasets")
